...
import com.dust.exmusic.fragments.searchfragments.AlbumsSearchFragment;
...
public class WholeAlbumsFragment extends Fragment {
        ...
        floatingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getActivity().getSupportFragmentManager().beginTransaction()
                        .replace(R.id.drawerLayout, new AlbumsSearchFragment())
                        .setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE)
                        .addToBackStack("AlbumsSearchFragment")
                        .commit();
            }
        });
    }
    ...
    private void setUpBackImage(View view) {
        backImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                getActivity().getSupportFragmentManager().popBackStack("WholeAlbumsFragment", FragmentManager.POP_BACK_STACK_INCLUSIVE);
            }
        });
    }
        ...
        nestedMain.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            ...
            public void onScrollChange(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                if (scrollY == v.getChildAt(0).getMeasuredHeight() - v.getMeasuredHeight()) {
                    ...
                    listMain.addAll(handler.getAlbumsFirstSong(pagination));
    ...
    private void setUpRecyclerView() {
        ...
        listMain.addAll(handler.getAlbumsFirstSong(pagination));
        mAdapter = new AlbumsRecyclerViewAdapter(listMain, getActivity().getSupportFragmentManager(), set);
    ...
    private void setUpViews(View view) {
        ...
        title.setText(getActivity().getResources().getString(R.string.albums));
