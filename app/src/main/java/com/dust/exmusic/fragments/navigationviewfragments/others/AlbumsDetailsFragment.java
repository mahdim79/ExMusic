...
public class AlbumsDetailsFragment extends Fragment {
    ...
    private void setUpFloatingActionButton() {
        ...
        floatingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sharedPreferencesCenter.setLastPlayMode(getJoinedShuffleMode("Albums", getArguments().getString("NAME")));
                sharedPreferencesCenter.setShuffleMode(getJoinedShuffleMode("Albums", getArguments().getString("NAME")));
                Intent intent = new Intent(getActivity(), PlayerActivity.class);
                intent.putExtra("PATH", data.get(0).getPath());
                intent.putExtra("SHUFFLE_MODE", "Albums");
                intent.putExtra("PLAY_LIST", getJoinedShuffleMode("Albums", getArguments().getString("NAME")));
    ...
    private void setUpRecyclerView() {
        data.addAll(new RealmHandler().getAlbumSongs(getArguments().getString("NAME")));
        ...
        mainRecyclerView.setAdapter(new AllMusicsRecyclerViewAdapter(data, getActivity(), getActivity().getSupportFragmentManager(), set, new SharedPreferencesCenter(getActivity()), setSeparatedListMode("Albums", getArguments().getString("NAME"))));
    }
    ...
    private void setUpBackImg() {
        backImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                getActivity().getSupportFragmentManager().popBackStack("AlbumsDetailsFragment", FragmentManager.POP_BACK_STACK_INCLUSIVE);
            }
        });
    }
    ...
    public static AlbumsDetailsFragment newInstance(String artistName) {
